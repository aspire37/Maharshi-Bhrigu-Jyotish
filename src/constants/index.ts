...
export const FEATURED_PRODUCTS: ProductType[] = [
  {
    id: '1',
    name: 'Kailas Yantra Pendant(Sphatic)',
    description: 'Kailas Yantra Pendant (Sphatik) for divine shielding and negative energy removal.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Create_kailas_yantra_202604180744.jpeg',
    ],
    stock: 15,
    sku: 'CRY-KailasYantra-002',
    benefits: [ 'Protection', 'Confidence'],
    featured: true,
  },
  {
    id: '2',
    name: 'Shree Yantra Pendant(Sphatic)',
    description: 'Shree Yantra Pendant (Sphatik) for ultimate abundance and cosmic harmony.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Create_Shree_Yantra_202604180749.jpeg',
    ],
    stock: 12,
    sku: 'CRY-ShreeYantra-001',
    benefits: ['Abundance','Business Success', 'Prosperity'],
    featured: true,
  },
  {
    id: '3',
    name: 'Crystal Bracelets',
    description: 'Clear Quartz (Sphatik): For mental clarity and amplification of positive energy.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Clear_Quartz_202604180814.jpeg',
    ],
    stock: 50,
    sku: 'CRYS-SPHATIC-002',
    benefits: ['MentalClarity', 'PositiveEnergy', 'Self Discovery'],
    featured: true,
  },
   {
    id: '4',
    name: 'Amethyst Bracelets',
    description: 'Amethyst: For stress relief, intuition, and peaceful sleep.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Amethyst_crystal_bracelets_202604180818.jpeg',
    ],
    stock: 50,
    sku: 'CRYS-SPHATIC-002',
    benefits: ['Intuition', 'PeacefulSleep', 'StressRelief'],
    featured: true,
  },
   {
    id: '5',
    name: 'Black Tourmaline Bracelets',
    description: ' Black Tourmaline: For ultimate grounding and protection against negativity.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Black_Tourmaline_bracelets_202604180822.jpeg',
    ],
    stock: 50,
    sku: 'CRYS-SPHATIC-002',
    benefits: ['Protection', 'PositiveEnergy', 'Grounding'],
    featured: true,
  },
   {
    id: '6',
    name: 'Rose Quartz Bracelets',
    description: 'Rose Quartz: For attracting love, emotional healing, and self-compassion.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Rose_Quartz_bracelets_202604180826.jpeg',
    ],
    stock: 50,
    sku: 'CRYS-SPHATIC-002',
    benefits: ['AttractLove', 'EmotionalHealing', 'Love Compassion'],
    featured: true,
  },
  {
    id: '7',
    name: 'Tiger’s Eye Bracelets',
    description: 'Tiger’s Eye: For courage, confidence, and manifesting willpower.',
    price: 1500,
    category: 'spiritual-items',
    images: [
      '/images/products/Tigers_Eye_bracelets_202604180828.jpeg',
    ],
    stock: 50,
    sku: 'CRYS-SPHATIC-002',
    benefits: ['Courage', 'Confidence', 'Willpower'],
    featured: true,
  },
  {
    id: '8',
    name: 'Pyrite Frames',
    description: 'Pyrite Frames for manifesting wealth and boosting business growth.',
    price: 300,
    category: 'spiritual-items',
    images: [
      '/images/products/Pyrite_frame_clean_202604180837.jpeg',
    ],
    stock: 25,
    sku: 'CRYS-PYRITE-001',
    benefits: ['Business Growth', 'Wealth', 'AttractMoney'],
    featured: true,
  },
